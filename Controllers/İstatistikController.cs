...
namespace OffOnOtomasyonu.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //var deger10 = (from x in c.SatisHarekets orderby x.Urunid descending select x.Urun.UrunAd).FirstOrDefault();
            //ViewBag.d10 = deger10;
            var deger10 = c.Uruns.Where(u => u.Urunid == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderBy(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(k => k.UrunAd).FirstOrDefault();
            ViewBag.d10 = deger10;

            //var deger11 = (from x in c.SatisHarekets orderby x.Urunid ascending select x.Urun.UrunAd).FirstOrDefault();
            //ViewBag.d11 = deger11;

            var deger11 = c.Uruns.Where(u => u.Urunid == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(k => k.UrunAd).FirstOrDefault();
            ViewBag.d11 = deger11;
            ...
            var deger13 = c.Giders.Where(x => x.Tarih == bugun).Sum(y => (decimal?)y.Tutar).ToString();
