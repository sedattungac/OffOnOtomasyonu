...
(function ($) {
    ...
    EasyDropDown.prototype = {
        ...
        render: function () {
            var self = this, touchClass = self.isTouch && self.nativeTouch ? ' touch' : '', disabledClass = self.disabled ? ' disabled' : '';
            ...
            $.each(self.options, function () {
                var option = this, active = option.selected ? ' class="active"' : '';
        ...
        select: function (index) {
            ...
            ;
            var option = self.options[index], selectIndex = self.hasLabel ? index + 1 : index;
