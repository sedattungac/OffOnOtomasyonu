    ...
    return /******/ (function (modules) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            _jquery2["default"].fn[plugin] = function (option) {
                var fnArgs = Array.prototype.slice.call(arguments, 1), isSingleElement = this.length === 1, returnValue = null;
                var $elements = this.each(function () {
                    var $this = (0, _jquery2["default"])(this), inst = $this.data(plugin), options = (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' ? option : {};
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var Swatches = function (_Palette) {
                ...
                _createClass(Swatches, [{
                        ...
                        value: function load() {
                            var _this2 = this;
                            var colorpicker = this.colorpicker, swatchContainer = this.element.find('.colorpicker-swatches--inner'), isAliased = this.options.namesAsValues === true && !Array.isArray(this.colors);
            ...
            var SliderHandler = function () {
                ...
                _createClass(SliderHandler, [{
                        ...
                        value: function defaultOnMove(top, left) {
                            ...
                            var slider = this.currentSlider, cp = this.colorpicker, ch = cp.colorHandler;
            ...
            var PopupHandler = function () {
                ...
                _createClass(PopupHandler, [{
                        ...
                        value: function hide(e) {
                            ...
                            var cp = this.colorpicker, clicking = this.clicking || this.isClickingInside(e);
                            this.hidding = true;
                            this.showing = false;
                            this.clicking = false;
            ...
            var PickerHandler = function () {
                ...
                _createClass(PickerHandler, [{
                        ...
                        value: function update() {
                            ...
                            var vertical = this.options.horizontal !== true, slider = vertical ? this.options.sliders : this.options.slidersHorz;
                            var saturationGuide = this.picker.find('.colorpicker-saturation .colorpicker-guide'), hueGuide = this.picker.find('.colorpicker-hue .colorpicker-guide'), alphaGuide = this.picker.find('.colorpicker-alpha .colorpicker-guide');
