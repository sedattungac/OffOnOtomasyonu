(function (assert) {
    var paper, url = 'http://raphaeljs.com';
    QUnit.module('DOM', {
        beforeEach: function () {
    ...
    var equalNodePosition = function (assert, node, expectedParent, expectedPreviousSibling, expectedNextSibling) {
    ...
    var equalNodePositionWrapped = function (assert, node, anchor, expectedParent, expectedPreviousSibling, expectedNextSibling) {
    ...
    QUnit.test('insertBefore: no element when wrapped in <a>', function (assert) {
        var el = paper.rect().attr('href', url), anchor = el.node.parentNode;
        el.insertBefore(null);
    ...
    QUnit.test('insertBefore: first element wrapped in <a> and wrapped in <a>', function (assert) {
        var x = paper.rect().attr('href', url), xAnchor = x.node.parentNode;
        var el = paper.rect().attr('href', url), anchor = el.node.parentNode;
        el.insertBefore(x);
    ...
    QUnit.test('insertBefore: middle element wrapped in <a> and wrapped in <a>', function (assert) {
        var x = paper.rect().attr('href', url), xAnchor = x.node.parentNode;
        var y = paper.rect().attr('href', url), yAnchor = y.node.parentNode;
        var el = paper.rect().attr('href', url), anchor = el.node.parentNode;
        el.insertBefore(y);
